...
package com.veit.alex.est.billingUtil;
...
public class IabBroadcastReceiver extends BroadcastReceiver {
     ...
     */
    public interface IabBroadcastListener { void receivedBroadcast(); }
    ...
    public IabBroadcastReceiver(IabBroadcastListener listener) { mListener = listener; }

    @Override
    public void onReceive(Context context, Intent intent) { if (mListener != null) { mListener.receivedBroadcast(); } }
}